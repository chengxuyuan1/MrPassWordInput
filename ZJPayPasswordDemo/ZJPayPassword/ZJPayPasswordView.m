...
- (void)initData
{
    ...
    for (int i = 0; i < kZJPasswordBoxNumber; i ++)
    {
        ...
        label.textColor = UIColorFromHEX(0x4285F4);
        label.layer.borderWidth = 4;
        label.layer.borderColor = UIColorFromHEX(0xD2D3D4).CGColor;
        label.backgroundColor=UIColorFromHEX(0xF3F3F3);
...
-(void)resetLabBlueColor:(UILabel *)label{
    label.layer.borderColor = UIColorFromHEX(0x4285F4).CGColor;
    label.backgroundColor=UIColorFromHEX(0xFFFFFF);
}
-(void)resetLabGrayColor:(UILabel *)label{
    label.layer.borderColor = UIColorFromHEX(0xD2D3D4).CGColor;
    label.backgroundColor=UIColorFromHEX(0xF3F3F3);
}
